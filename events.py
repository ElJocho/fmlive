...
BOMB_NEXT_TO_ENEMY = 'BOMB_NEXT_TO_ENEMY'
BOMB_NEXT_TO_CRATE_RIGHT = 'BOMB_NEXT_TO_CRATE_RIGHT'
BOMB_NEXT_TO_CRATE_DOWN = 'BOMB_NEXT_TO_CRATE_DOWN'


BOMB_USELESS = 'BOMB_USELESS'
